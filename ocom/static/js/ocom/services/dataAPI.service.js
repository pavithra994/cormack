...
(function () {
    angular
        ...
        .factory("dataResourceService", ['$rootScope', '$resource', '$localStorage', '$timeout', '$state',
            ...
            /**
             * This (the DataResourceService) is the class that actually fetches information from the 
             * @param {*} $rootScope 
             * @param {*} $resource 
             * @param {*} $localStorage 
             * @param {*} $timeout 
        ...
        /**
         * The Data API Service is the "newer" and preferred way of accessing data from the app.
         * 
         * Usage
         * -----
         * 
        ...
        .factory("dataAPIService", [
                ...
                platform)
            {
                 ...
                 * We will be replacing this implementation later; at the moment this is just a proxy to $resource.
                 * @param {*} base 
                ...
                function getDataApi(base, modelName) {
                    ...
                    return {
                        /**
                         * List the given model, from offline storage if available.
                         * @param {*} options 
                        ...
                        /**
                         * Get the item with the given ID of the given model's type.
                         * @param {*} id 
                         * @param {*} successCallback 
                         * @param {*} failureCallback 
                         */
                        ...
                        /**
                         * Create a new item of the model type.
                         * @param {*} item 
                         * @param {*} successCallback 
                         * @param {*} failureCallback 
                         */
                        ...
                        /**
                         * Update an extant item of the model type.
                         * @param {*} id 
                         * @param {*} item 
                         * @param {*} successCallback 
                         * @param {*} failureCallback 
                        ...
                        /**
                         * Patch an extant item of the model type.
                         * @param {*} item 
                         * @param {*} successCallback 
                         * @param {*} failureCallback 
                         */
                        ...
                        /**
                         * Delete an extant item of the model's type.
                         * @param {*} item 
                         * @param {*} successCallback 
                         * @param {*} failureCallback 
                         */
